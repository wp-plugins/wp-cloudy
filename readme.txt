...
* NEW! Import/export settings from site to another site<br/>
* NEW! Responsive design for Skins add-on <br />
* NEW! AJAX<br />
* NEW! Responsive design<br />
* NEW! Choose between 2 forecast fonts (required WP Cloudy Skins Add-on)<br />
* NEW! Display date of last update<br />
* NEW! Display link to full weather (OpenWeatherMap)<br />
* NEW! 16 days forecast<br />
* NEW! Option to disable mouse scroll wheel zoom on map<br />
* NEW! Use your own custom fields from posts to build automatic weathers (add-on Geolocation required)<br />
