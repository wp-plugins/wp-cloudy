...
function get_color_text($attr,$content) {
		extract(shortcode_atts(array( 'id' => ''), $attr));
		$wpc_text_color_value = get_post_meta($id,'_wpcloudy_meta_text_color',true);
...
function wpcloudy_display_weather($attr,$content) {
		...
		extract(shortcode_atts(array( 'id' => ''), $attr));
			...
			echo '<div id="wpc-weather" class="'. $wpcloudy_size .'" style="background:'. $wpcloudy_meta_bg_color .';color:'. $wpcloudy_meta_text_color .';border:1px solid '. $wpcloudy_meta_border_color .'">';
